...
public static class Configuration
{
    ...
    [
        new(nameof(AutoLoadRows), "Integer", "10000", "Minimum: 1. When no value is specified, default to 10000 for \"Load\"."),
    ...
    /// </summary>
    public static string GetRawValue(string key) => ConfigurationManager.AppSettings[key] ?? Settings.First(s => s.Key == key).DefaultValue;
